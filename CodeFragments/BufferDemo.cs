...
namespace CodeFragments
{
    public class BufferDemo
    {
        public static void Exection()
        {
            ...
            // byte max value:255
            // aa = 0b00000100; 丢失 int ... 00000100 之前的位数。
            byte aa = (byte)value;
            ...
            Console.WriteLine(Buffer.GetByte(b, 0)); // 4
            Console.WriteLine(Buffer.GetByte(b, 1)); // 1
            Console.WriteLine(Buffer.GetByte(b, 2)); // 0
            Console.WriteLine(Buffer.GetByte(b, 3)); // 0
            ...
            Test testSpan2 = MemoryMarshal.Read<Test>(tmp);
    ...
    public class SpanTest
    {
        ...
        [Benchmark]
        public bool StructuralEqual()
        {
            return StructuralComparisons.StructuralEqualityComparer.Equals(_a, _b);
        }
    }
    public struct Test
    {
