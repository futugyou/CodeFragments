...
public class CreateTimerRequest
{
    ...
    private class CreateTimerRequestJson
    {
        [JsonPropertyName("actorId")]
        public string ActorID { get; set; }
        [JsonPropertyName("actorType")]
    ...
    public sealed class JsonConverter : JsonConverter<CreateTimerRequest>
    {
        public override CreateTimerRequest? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var defaultReminder = JsonSerializer.Deserialize<CreateTimerRequestJson>(root.GetRawText(), options);
        ...
        public override void Write(Utf8JsonWriter writer, CreateTimerRequest value, JsonSerializerOptions options)
        {
