...
public class HomeController
{
    ...
    public ValueTask<AspnetcoreEx.MiniMVC.IActionResult> Baz(Result input) => ValueTask.FromResult<AspnetcoreEx.MiniMVC.IActionResult>(new AspnetcoreEx.MiniMVC.JsonResult(input));
}
