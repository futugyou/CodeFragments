...
public abstract class BM25
{
    ...
    protected readonly Dictionary<string, int> _docFreqs;
    ...
    protected abstract double[] GetScores(List<string> query);
    protected abstract double[] GetBatchScores(List<string> query, List<int> docIds);
