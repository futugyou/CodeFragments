...
public static class AgentEndpoints
{
    ...
    static IAsyncEnumerable<string> Function([FromServices] AgentService agentService)
    {
        return agentService.Function();
    }

    static IAsyncEnumerable<string> Approval([FromServices] AgentService agentService, bool allowChangeState = false)
    {
        return agentService.Approval(allowChangeState);
    }
    ...
    static IAsyncEnumerable<string> AgentToTool([FromServices] AgentService agentService)
    {
        return agentService.AgentToTool();
    }
