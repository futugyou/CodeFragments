...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddAgentServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAIAgent("agui_plan", (sp, name) =>
        {
            ...
            {
                Name = "agui_plan",
                Description = "An agent that generates agentic user interfaces using LLM",
        ...
        // Most of the time, the file base does not read the `conversion-table.md`; 
        // There is only a 1-in-10 chance that it will actually execute the `convert.py`. 
