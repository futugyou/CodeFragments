...
public class DeclarativeService
{
    ...
    public DeclarativeService(Kernel kernel, IOptionsMonitor<SemanticKernelOptions> optionsMonitor)
    {
        _kernel = kernel;
    ...
    public async IAsyncEnumerable<string> Function(string query)
    {
    ...
    public async IAsyncEnumerable<string> Template(string topic, string length)
    {
        var text =
            """
            type: chat_completion_agent
