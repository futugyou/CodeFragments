...
public class UserQuery
{
    ...
    //   }
    // }
    public async Task<User?> GetUser(int id, [Service] IUserRepository repository, [Service] IHttpContextAccessor httpContextAccessor)
    {
    ...
    //   }
    // }
    [UseFiltering(typeof(CustomerUserFilterType))]
