...
namespace Other
{
    ...
    class BloomFilter
    {
        public static void LargeInputTestAutoError()
        {
        ...
        public static void LargeInputTest()
        {
            // set filter properties
            int capacity = 2000000;
        ...
        public static void OverLargeInputTest()
        {
            // set filter properties
        ...
        public static void NoFalseNegativesTest()
        {
            // set filter properties
            int capacity = 10000;
            ...
            foreach (string input in inputs)
            {
                if (target.Contains(input) == false)
                    Console.WriteLine("False negative: {0}", input);
            }
        }

        public static void LowProbabilityFalseTest()
        {
            ...
            if (target.Contains(Guid.NewGuid().ToString()) == true)
                Console.WriteLine("Check for missing item returned true.");
        }
        public static void FalsePositivesInRangeTest()
        {
            // set filter properties
            ...
            if (falsePositives > expectedFalsePositives)
                Console.WriteLine("Number of false positives ({0}) greater than expected ({1}).", falsePositives, expectedFalsePositives);
        }
